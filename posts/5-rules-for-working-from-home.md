...
![](/imgs/posts/tasks.gif)

Заведите таск-менеджер, или научитесь пользоваться тем, что принят в вашей компании. Вы, как "удалёнщик" должны лучше всех уметь работать с этой программой (можете почитать статью "Вы устраиваетесь джуном?"). А уже затем, научиться стоять на своём.
